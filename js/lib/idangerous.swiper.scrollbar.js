Swiper1.prototype.plugins.scrollbar=function(swiper,params){var enabled=params&&params.container;if(!enabled)return;var defaults={hide:true,draggable:true,snapOnRelease:false}
...
drag.className='swiper-scrollbar-drag';if(params.draggable)drag.className+=' swiper-scrollbar-cursor-drag';if(track.innerHTML==''){track.appendChild(drag);};if(params.hide)track.style.opacity=0;var te=swiper.touchEvents
